...
; --------------------------------------------------
; By B. Chiha May-2023
; Source: TEC-1G/TEC-Deck/Graphical_LCD/programs/glcd_maze-10.z80
...
START:	
		...
		LD A,G_SET_GR_MODE
		RST 18H
		LD A,G_SET_BUF_NO_CLEAR ;On every PLOT_TO_LCD Don't clear the Buffer
		RST 18H
...
MAIN_LOOP:	
		...
		LD A,G_PLOT_TO_LCD ;Update LCD with Graphics Buffer
		RST 18H
