...
; ----------------------------------
; By B. Chiha May-2023
; Source: TEC-1G/TEC-Deck/Graphical_LCD/programs/glcd_mad-10.z80
...
START:	
        ...
        LD A,G_SET_GR_MODE
        RST 18H
        LD A,G_SET_BUF_NO_CLEAR ;Set No Clear, to retrain existing buffer
        RST 18H
...
MAD_LOOP:	
        ...
        INC HL
        PUSH HL
        LD A,G_DRAW_LINE ;Draw a line between BC and DE
        RST 18H
        LD A,G_PLOT_TO_LCD ;Plot the line to the LCD
        RST 18H
        POP HL
        JR MAD_LOOP
...
DO_MAD_FAST:	
        ...
        LD A,G_SET_GR_MODE
        RST 18H
        LD A,G_SET_BUF_CLEAR ;Set No Clear, to retrain existing buffer
        RST 18H
        LD HL, MAD_DATA
MAD_LOOP1:	
        LD A, (HL) 		;Get X0
