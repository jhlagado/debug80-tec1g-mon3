...
; ---------------------------------
; By B. Chiha May-2023
; Source: TEC-1G/TEC-Deck/Graphical_LCD/programs/glcd_3d_demo-10.z80
; Adapted for debug80-tec1g (ORG 0x4000 for MON-3 user RAM).
...
;Clear menu and set screen for graphics
        LD A,G_CLEAR_TXT_LCD ;Clear Text LCD
        RST 18H
        LD A,G_SET_GR_MODE ;Set LCD in Graphics Mode
        RST 18H
        LD A,G_SET_BUF_CLEAR ;Set to Clear GBUF after updated
        RST 18H
...
;      integer. Stack has X1,Y1,X0,Y0 if you pop in this order
        ...
        LD A,G_DRAW_LINE ;DRAW a line from BC to DE to Graph Buffer
        RST 18H
...
;Draw Heading - Print String Example
        ...
        RST 18H
        LD C, 00H 		;Row 0
        LD A,G_PRINT_STRING ;Print String at row 1
        RST 18H
        DB " TEC 3D Shapes  ",0
;Inverse Heading - Fill Box and Inverse Example
        ...
        LD BC, 0000H 	;X0, Y0
        LD DE, 7F0FH 	;X1, Y1
        LD A,G_FILL_BOX ;Draw fill box from X0,Y0 to X1,Y1
        RST 18H
;Draw Box - Box Outline Example
        LD BC, 0020H 	;X0, Y0
        LD DE, 7F3FH 	;X1, Y1
        LD A,G_DRAW_BOX ;Draw a outline box from X0,Y0 to X1,Y1
        RST 18H
;Draw Menu Options - Print Chars Example
        ...
        LD A,G_PRINT_CHARS ;Display Text
        RST 18H
...
PIXEL_LOOP:	
        ...
        INC DE
        LD A,G_DRAW_PIXEL ;Draw a pixel at BC or X,Y
        RST 18H
        JR PIXEL_LOOP
END_PIXEL:	
